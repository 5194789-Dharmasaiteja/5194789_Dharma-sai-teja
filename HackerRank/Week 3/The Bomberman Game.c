 ...
 *
 */
char** cloneGrid(int r, int c, char** grid) {
...
char** bomberMan(int n, int grid_count, char** grid, int* result_count) {
    ...
    *result_count = r;
    ...
    char** after1 = explode(r, c, grid);

    if (n % 4 == 3) {
        return after1;
    } else {
        char** after2 = explode(r, c, after1);
        return after2;
    }
}
